...
async function getTrainers(options = {}) {
    ...
    const selectBaseFull = 'id, name, avatar_url, rating, review_count, location, specialty, bio, plans, tags, kyc_verified, certificates_verified, verification_status, experience, training_mode, profile_completion_score, last_active_at, boost_expires_at, subscription_plan';
...
async function searchTrainers(query, location, mode) {
    ...
    const selectBaseFull = 'id, name, avatar_url, rating, review_count, location, specialty, bio, plans, tags, training_mode, profile_completion_score, last_active_at, boost_expires_at, subscription_plan';
